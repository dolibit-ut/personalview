 ...
 */
class personnalviewbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "personnalview@personnalview";
    public $boxlabel;
    public $depends = array("personnalview");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/personnalview/class/personnalview.class.php";
